...
// DataValue sets data value.
func (w *ConfigMapWrapper) DataValue(key, value string) *ConfigMapWrapper {
	if w.ConfigMap.Data == nil {
		w.ConfigMap.Data = make(map[string]string)
	}
	w.ConfigMap.Data[key] = value
	return w
}
